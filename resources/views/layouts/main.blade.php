        ...
        <div class="flex flex-col md:flex-row items-center">
           <!--  search goes here  -->
            ...
            <div class="md:ml-4 mt-3 md:mt-0">
                <a href="#">
                    <img src="/img/avatar.jpg" alt="avatar" class="rounded-full w-8 h-8" width="20" height="20">
                </a>
            </div>
        </div>
    </div>
